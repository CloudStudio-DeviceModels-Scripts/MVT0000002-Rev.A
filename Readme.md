...
# Parsing + Configuration Script – MVT_0000002 - Rev. A

This **Parsing + Configuration** script is designed for the **MVT_0000002** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – MVT_0000002 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **MVT_0000002** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
